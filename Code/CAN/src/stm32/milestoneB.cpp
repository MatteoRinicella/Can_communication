...
extern "C" void run_milestone_B(){
    ...
    { //inizio scope
        ...
        log("END DEBUG SESSION\r\n");
        log("\n");

        // TX: invio tester present
        //Frame tx = Frame::make_std(0X7E0,{0X02, 0X3E,0X80});
        Frame tx = Frame::make_std(0X7E0,{0X02, 0X3E,0X00});
        log("-------------------\r\n");
